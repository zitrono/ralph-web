 ...
 */
export const logClaudeDesktopRequest = (data, context) => {
    try {
 ...
 */
export const logRawRequest = (requestObject, toolName, clientInfo) => {
    try {
...
export const logger = {
     ...
     */
    rawRequest: (requestObject, toolName, clientInfo) => {
