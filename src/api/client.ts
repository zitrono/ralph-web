...
import { ClozeApiResponse, ClozeErrorResponse } from './types.js';
...
const createAxiosInstance = (): AxiosInstance => {
  ...
  instance.interceptors.response.use(
    ...
    (error) => {
      ...
      const errorResponse = error.response?.data as ClozeErrorResponse | undefined;
...
export const apiClient = {
   ...
   */
  get: async <T extends ClozeApiResponse>(
    url: string,
   ...
   */
  post: async <T extends ClozeApiResponse>(
    url: string,
   ...
   */
  delete: async <T extends ClozeApiResponse>(
    url: string,
    params: Record<string, any> = {}
  ): Promise<T> => {
    try {
