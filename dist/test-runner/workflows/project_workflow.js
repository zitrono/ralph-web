 ...
 */
export async function testProjectWorkflow(server) {
    ...
    if (project.name !== projectName ||
        !project.appLinks ||
        !project.appLinks.some((link) => link.uniqueid === uniqueId) ||
    ...
    if (updatedProject.summary !== 'Updated project description' ||
        ...
        !updatedProject.appLinks.some((link) => link.url === 'https://example.org/updated')) {
...
//# sourceMappingURL=project_workflow.js.map