 ...
 */
export function handleApiError(error: any, toolName: string): Record<string, any> {
...
export class TestHelper {
   ...
   */
  async assertSucceeds(operation: () => Promise<any>, message?: string): Promise<any> {
    try {
   ...
   */
  async assertFails(operation: () => Promise<any>, message?: string): Promise<void> {
    try {
      await operation();
