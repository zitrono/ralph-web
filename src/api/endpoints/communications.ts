 ...
 */
export const createCommunication = async (communication: Communication): Promise<ClozeApiResponse> => {
  logger.debug('Creating communication record:', communication);
  return apiClient.post<ClozeApiResponse>('/v1/timeline/communication/create', communication);
};
 ...
 */
export const addMeeting = async (meeting: Omit<Communication, 'style'> & { style?: 'meeting' }): Promise<ClozeApiResponse> => {
  ...
  const meetingData: Communication = {
    date: meeting.date,
 ...
 */
export const addNote = async (note: Omit<Communication, 'style'> & { style?: 'direct' }): Promise<ClozeApiResponse> => {
 ...
 */
export const logEmail = async (email: Omit<Communication, 'style'> & { style?: 'email' }): Promise<ClozeApiResponse> => {
